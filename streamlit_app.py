...
st.set_page_config(
    page_title="Custiva : Analisis Faktor Kepuasan & Loyalitas Pelanggan",
    layout="wide",
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px;">
        <div style="display: flex; align-items: center; gap: 15px;">
            ...
            <div>
                ...
                <p style="margin:0; font-size:24px; color:#047857; font-weight:500;">
                    ANALISIS FAKTOR YANG BERPENGARUH TERHADAP KEPUASAN DAN LOYALITAS PELANGGAN MENGGUNAKAN MODEL XGBOOST (EXTREME GRADIENT BOOSTING) REGRESSOR
                </p>
            </div>
        </div>
    </div>
...
if st.session_state.current_step == 1:
    ...
    <div class="custom-card">
        <h2 style="margin-top:0; font-size:22px; color:#064e3b; margin-bottom:12px;">SELAMAT DATANG DI APLIKASI DASHBOARD ANALISIS PELANGGAN CUSTIVA</h2>
...
# ANALISIS DESKRIPTIF
    ...
    if st.session_state.df is None:
        ...
        # Graphical Charts (Tabs inside Step 2)
        st.write("")
        st.markdown("""
        <h3 style="font-size:16px; margin-bottom:12px; color:#064e3b; font-family:'Plus Jakarta Sans', sans-serif;">
